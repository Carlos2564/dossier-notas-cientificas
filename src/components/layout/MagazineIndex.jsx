...
export default function MagazineIndex() {
  const chapters = [
    ...
    { num: "04", title: "Revolución Industrial y Sociedad", icon: Globe, color: "from-blue-600 to-cyan-500" },
    { num: "05", title: "Impacto Histórico y Brecha", icon: Smartphone, color: "from-purple-500 to-pink-500" },
    { num: "06", title: "Competencias Digitales", icon: Cpu, color: "from-amber-500 to-yellow-400" },
    { num: "07", title: "Videoconferencia y Virtualidad", icon: Layers, color: "from-emerald-500 to-green-400" },
    { num: "08", title: "Capacitación Docente y TIC", icon: Zap, color: "from-indigo-500 to-blue-600" },
    { num: "09", title: "Seguridad de la Información", icon: Shield, color: "from-rose-500 to-red-600" },
